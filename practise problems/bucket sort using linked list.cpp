...
void bucketSort(int *arr, int n, int max) {
	...
	for (i = 0; i < n; ++i) {
    	...
    	if (list_arr[index].last_node_address == NULL ||      list_arr[index].first_node_address == NULL) {
	...
	for (i = 0; i < n; ++i) {
    	if (list_arr[i].first_node_address != NULL && list_arr[i].first_node_address != list_arr[i].last_node_address) {
	...
	for (i = 0; i < n; ++i) {
    	...
    	if (list_arr[i].first_node_address != NULL && list_arr[i].last_node_address != NULL) {
